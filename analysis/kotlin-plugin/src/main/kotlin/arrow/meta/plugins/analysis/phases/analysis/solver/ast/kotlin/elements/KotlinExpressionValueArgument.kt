...
open class KotlinExpressionValueArgument(open val impl: org.jetbrains.kotlin.psi.KtValueArgument) :
  ValueArgument, KotlinElement {
  override fun impl(): org.jetbrains.kotlin.psi.KtValueArgument = impl

  override fun getArgumentName(): ValueArgumentName? = impl().getArgumentName()?.model()
